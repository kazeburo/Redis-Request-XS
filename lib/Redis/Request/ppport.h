...
----------------------------------------------------------------------
    ...
    lib/Redis/Request/ppport.h -- Perl/Pollution/Portability Version 3.21
    ...
    Use 'perldoc lib/Redis/Request/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl lib/Redis/Request/ppport.h [options] [source files]
...
This version of F<lib/Redis/Request/ppport.h> is designed to support operation with Perl
...
Display the version of F<lib/Redis/Request/ppport.h>.
...
Tell F<lib/Redis/Request/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003. You can use this option to reduce the output
of F<lib/Redis/Request/ppport.h> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<lib/Redis/Request/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<lib/Redis/Request/ppport.h> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<lib/Redis/Request/ppport.h>.
This reduces the size of F<lib/Redis/Request/ppport.h> dramatically and may be useful
if you want to include F<lib/Redis/Request/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<lib/Redis/Request/ppport.h> will have a C<--unstrip> option that allows
...
F<lib/Redis/Request/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be supported by
F<lib/Redis/Request/ppport.h> and below which version of Perl they probably
...
earlier Perl releases. Use
    ...
    perl lib/Redis/Request/ppport.h --list-provided

to see which API elements are provided by lib/Redis/Request/ppport.h.
...
also deprecated. You can safely use the supported API, as F<lib/Redis/Request/ppport.h>
...
more C<#define>s in your source code before the inclusion of F<lib/Redis/Request/ppport.h>.
...
macro. Just C<#define> the macro before including C<lib/Redis/Request/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "lib/Redis/Request/ppport.h"
...
F<lib/Redis/Request/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<lib/Redis/Request/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<lib/Redis/Request/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl lib/Redis/Request/ppport.h
...
use something like this:
    ...
    perl lib/Redis/Request/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl lib/Redis/Request/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl lib/Redis/Request/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl lib/Redis/Request/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl lib/Redis/Request/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl lib/Redis/Request/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl lib/Redis/Request/ppport.h --api-info=/./

to display information for all known API elements.

=head1 BUGS

If this version of F<lib/Redis/Request/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<lib/Redis/Request/ppport.h> was generated using the latest version of
 ...
 */
#if PERL_REVISION != 5
#  error lib/Redis/Request/ppport.h only works with Perl version 5
 ...
 * 5.005 perls, you can use aTHXR (supplied by lib/Redis/Request/ppport.h), which will
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, lib/Redis/Request/ppport.h implements a version
...
/* End of File lib/Redis/Request/ppport.h */
